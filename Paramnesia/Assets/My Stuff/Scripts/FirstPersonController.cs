...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private readonly InputAction moveLeft = new InputAction(type: InputActionType.Button, binding: "<keyboard>/a", interactions: "");
        private readonly InputAction moveRight = new InputAction(type: InputActionType.Button, binding: "<keyboard>/d", interactions: "");
        private readonly InputAction moveForward = new InputAction(type: InputActionType.Button, binding: "<keyboard>/w", interactions: "");
        private readonly InputAction moveBack = new InputAction(type: InputActionType.Button, binding: "<keyboard>/s", interactions: "");
        private readonly InputAction crouch = new InputAction(type: InputActionType.Button, binding: "<Mouse>/rightButton", interactions: "");
        private readonly InputAction sprint = new InputAction(type: InputActionType.Button, binding: "<Mouse>/leftButton", interactions: "");
        private readonly InputAction jump = new InputAction(type: InputActionType.Button, binding: "<keyboard>/space");
